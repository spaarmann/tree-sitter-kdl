...
enum {
  ...
  aux_sym_single_line_comment_token1 = 27,
  sym_document = 28,
  sym_node = 29,
  ...
  aux_sym_single_line_comment_repeat1 = 58,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_single_line_comment, 3),
  [65] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_single_line_comment, 3),
  ...
  [230] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_single_line_comment_repeat1, 2),
  [232] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_single_line_comment_repeat1, 2), SHIFT_REPEAT(68),
